...
.charter-content { font-size: 1.2em; line-height: 1.7; color: #333; }
.charter-content .charter-title { text-align: center; font-weight: 600; margin-bottom: 20px; font-size: 1.25em; }
.charter-content h3 { font-size: 1.15em; color: #1a3c1a; margin-top: 24px; margin-bottom: 12px; }
.charter-content h4 { font-size: 1.1em; color: #2a5a2a; margin-top: 16px; margin-bottom: 8px; }
