...
class ArticleSectionSeeder extends Seeder
{
    public function run(): void
    {
        $sections = [
            ...
            ['slug' => 'finance', 'name' => 'Финансы', 'route_name' => 'finance', 'sort_order' => 8],
            // Подразделы страницы «Финансы» (работают как новости)
            ['slug' => 'forecast', 'name' => 'Прогноз социально-экономического развития Сергиево-Посадского городского округа Московской области', 'route_name' => 'finance.section', 'sort_order' => 9],
            ['slug' => 'report', 'name' => 'Доклад Главы', 'route_name' => 'finance.section', 'sort_order' => 10],
            ['slug' => 'programs', 'name' => 'Программы', 'route_name' => 'finance.section', 'sort_order' => 11],
            ['slug' => 'programs-archive', 'name' => 'Архив программ', 'route_name' => 'finance.section', 'sort_order' => 12],
            ['slug' => 'social-partnership', 'name' => 'Социальное партнерство', 'route_name' => 'finance.section', 'sort_order' => 13],
